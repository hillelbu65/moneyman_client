...
export const  CurrencyProvider = (props) => 
{
    ...
    useEffect(() => {
        const icons = [
            'Shekel',<TbCurrencyShekel/>, 
            'Rupee',<TbCurrencyRupee/>, 
            'Dolar',<TbCurrencyDollar/>, 
            'Euro',<TbCurrencyEuro/>,
            'Frank',<TbCurrencyFrank/>,
            'Pound',<TbCurrencyPound/>,
            'Yen',<TbCurrencyYen/>,
            'Riyal',<TbCurrencyRiyal/>,
            'Bitcoin',<TbCurrencyBitcoin/>,
            'Won',<TbCurrencyWon/>
        ]
    ...
    return ( 
        <CurrencyContext.Provider value = {[[currencyContext, setCurrencyContext], [itsUpdate, setItsUpdate]]}>
            {props.children}
