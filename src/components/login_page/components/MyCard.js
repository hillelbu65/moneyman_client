...
export default function MyCard() {
  ...
  return (
    <div
      className={`flex flex-row absolute bottom-10 items-center ${
        popup ? " animate-comeLeft" : "  animate-comeRight"
      } ${
        popup ? "right-0" : " -right-80"
      } h-fit w-96 bg-my_main_contrast rounded-l-lg p-4`}
    ...
    >
      ...
      <div className=" text-my_creame font-semibold justify-start text-start w-full">
        ...
        <div className="flex flex-col p-2 text-sm gap-2">
          <p>
            This app is a GUI for moneyman.
            <br />
