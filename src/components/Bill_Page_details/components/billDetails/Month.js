...
export default function Month(props) {
    ...
    const monthName = props.monthName[2] + props.monthName[3] + props.monthName[4]
  ...
  return (
    <div className='flex flex-col p-2 justify-center h-fit rounded-md gap-2 '>
        <div className='flex flex-row  items-center'>
            <div className='flex h-12 w-12 bg-my_main_contrast text-my_creame rounded-md p-2 justify-center items-center font-semibold'>{monthName}</div>
