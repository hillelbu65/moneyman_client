  ...
  return (
    <div className='flex flex-col p-3'>
        ...
        <div className='flex flex-col gap-3 mt-4 p-2'>
            ...
            onClick={() => {Cookies.set('Currency', 'Shekel', {expires: 7}); setItsUpdate('Shekel')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Dolar', {expires: 7}); setItsUpdate('Dolar')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Euro', {expires: 7}); setItsUpdate('Euro')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Rupee', {expires: 7}); setItsUpdate('Rupee')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Pound', {expires: 7}); setItsUpdate('Pound')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Frank', {expires: 7}); setItsUpdate('Frank')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Yen', {expires: 7}); setItsUpdate('Yen')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Riyal', {expires: 7}); setItsUpdate('Riyal')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Bitcoin', {expires: 7}); setItsUpdate('Bitcoin')}}>
            ...
            onClick={() => {Cookies.set('Currency', 'Won', {expires: 7}); setItsUpdate('Won')}}>
